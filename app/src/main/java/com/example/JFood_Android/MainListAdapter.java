...
public class MainListAdapter extends BaseExpandableListAdapter {
    ...
    public MainListAdapter(Context context, ArrayList<String> listDataHeader,
                           HashMap<String, ArrayList<String>> listChildData) {
        Log.d("foods","listDataHeader: "+String.valueOf(listDataHeader));
        Log.d("foods","listChildData: "+String.valueOf(listChildData));
